...
| Entrega | Material                                                           |
|---------+--------------------------------------------------------------------|
| 1ª      | [[https://github.com/mathrt-code/engsoft/blob/master/docs/entrega/descricao_geral.org][Descrição Geral]]                                                    |
| 2ª      | [[https://github.com/mathrt-code/engsoft/blob/master/docs/entrega/levantamento_requisitos.org][Levantamento de Requisitos]], [[https://github.com/mathrt-code/engsoft/blob/master/docs/analise_riscos.org][Matrizes SWOT]] |
| 3ª      | [[https://github.com/mathrt-code/engsoft/blob/master/docs/crcCards.pdf][CRC Cards]]                                                          |
| 4º      | [[https://github.com/mathrt-code/engsoft/blob/master/docs/umls.pdf][UMLs]], [[https://github.com/mathrt-code/engsoft/blob/master/docs/entrega/especificacao_teste.org][Especificação de testes]]                                      |
| 5º      | [[https://github.com/mathrt-code/engsoft/blob/master/docs/entrega/evolucao.org][Qualidade e evolução]]                                               |
|---------+--------------------------------------------------------------------|
